...
struct SlideDotParam : public dmlc::Parameter<SlideDotParam> {
  bool transpose_a;
  bool transpose_b;
  dmlc::optional<int> forward_stype;
  DMLC_DECLARE_PARAMETER(SlideDotParam) {
...
void SlideDotForward_(const nnvm::NodeAttrs& attrs,
                      const OpContext& ctx,
...
inline bool SlideDotForwardInferStorageType(const nnvm::NodeAttrs& attrs,
                                            const int dev_mask,
...
inline bool SlideDotShape(const nnvm::NodeAttrs& attrs,
